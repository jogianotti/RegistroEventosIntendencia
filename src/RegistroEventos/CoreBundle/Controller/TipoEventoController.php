...
class TipoEventoController extends Controller
{
    ...
    public function createAction(Request $request)
    {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('administracion_tipos_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(TipoEvento $entity)
    {
        $form = $this->createForm(new TipoEventoType(), $entity, array(
            'action' => $this->generateUrl('administracion_tipos_create'),
            'method' => 'POST',
        ));
    ...
    */
    ...
    {
        $form = $this->createForm(new TipoEventoType(), $entity, array(
            'action' => $this->generateUrl('administracion_tipos_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
    ...
    public function updateAction(Request $request, $id)
    {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('administracion_tipos_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id)
    {
        ...
        return $this->redirect($this->generateUrl('administracion_tipos'));
    }
    ...
    private function createDeleteForm($id)
    {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('administracion_tipos_delete', array('id' => $id)))
            ->setMethod('DELETE')
